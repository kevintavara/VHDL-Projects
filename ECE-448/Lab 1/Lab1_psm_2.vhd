...
entity CU is
  port (
    ...
    \FSM_sequential_p_state_reg[0]_0\ : out STD_LOGIC_VECTOR ( 2 downto 0 );
    \FSM_sequential_p_state_reg[1]_1\ : out STD_LOGIC_VECTOR ( 4 downto 0 );
    SS : out STD_LOGIC_VECTOR ( 0 to 0 );
    done_OBUF : out STD_LOGIC;
    start_IBUF : in STD_LOGIC;
    \PISO_reg[1]\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
    B_IBUF : in STD_LOGIC_VECTOR ( 2 downto 0 );
...
architecture STRUCTURE of CU is
  ...
  attribute SOFT_HLUTNM of \PISO[0]_i_1\ : label is "soft_lutpair9";
...
\PISO[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \^q\(0),
      I3 => \^q\(1),
      O => \FSM_sequential_p_state_reg[0]_0\(2)
    );
...
entity DP is
  port (
    ...
    \PISO_reg[2]_0\ : out STD_LOGIC_VECTOR ( 2 downto 0 );
    start_IBUF : in STD_LOGIC;
    ...
    \PISO_reg[2]_1\ : in STD_LOGIC_VECTOR ( 2 downto 0 )
  );
end DP;
...
U0: entity work.DP
     port map (
      ...
      E(0) => n_state(1),
      Mode_IBUF => Mode_IBUF,
      \PISO_reg[2]_0\(2 downto 1) => p_0_in(1 downto 0),
      \PISO_reg[2]_0\(0) => lsb_s,
      \PISO_reg[2]_1\(2) => U2_n_4,
      \PISO_reg[2]_1\(1) => U2_n_5,
      \PISO_reg[2]_1\(0) => U2_n_6,
...
U2: entity work.CU
     port map (
      ...
      B_IBUF(2 downto 0) => B_IBUF(2 downto 0),
      CLK => clk_IBUF_BUFG,
      D(0) => n_state(1),
      \FSM_sequential_p_state_reg[0]_0\(2) => U2_n_4,
      \FSM_sequential_p_state_reg[0]_0\(1) => U2_n_5,
      \FSM_sequential_p_state_reg[0]_0\(0) => U2_n_6,
      ...
      Mode_IBUF => Mode_IBUF,
      \PISO_reg[1]\(2 downto 1) => p_0_in(1 downto 0),
      \PISO_reg[1]\(0) => lsb_s,
      Q(1 downto 0) => p_state(1 downto 0),
      SS(0) => init_s,
...
Z_OBUF_inst_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"01FF0100"
    )
        port map (
